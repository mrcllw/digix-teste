...
export const pessoaPretendente = new Pessoa('Teste', TipoDePessoa.PRETENDENTE, new Date(2020, 4, 12), 10)
export const pessoaDependente = new Pessoa('Teste', TipoDePessoa.DEPENDENTE, new Date(), 10)
